...
// paraméteres konstruktor member initializer list-el
/*
Player::Player(const std::string& name_, int positionX_ = 0, int positionY_ = 0)
...
int main(int argc, char const *argv[])
{
    ...
    */
    ...
    // kiírásnál először dereferálnunk kell a mutatott objektumot majd ezek után a . operátorral segítségével tudunk
